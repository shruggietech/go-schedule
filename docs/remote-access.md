...
No network implementation begins until S074 and [issue #165](https://github.com/shruggietech/go-schedule/issues/165) are reviewed and merged. Each downstream issue remains open until its functional acceptance criteria are delivered. Verification findings are tracked as separate bug issues against the affected active release.
