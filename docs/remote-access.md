...
| Reverse-proxied HTTPS | Explicit private address with direct go-schedule TLS; proxy adds public TLS | Application TLS, authentication, authorization, trusted-proxy allowlist, limits, audit | Proxy lifecycle, public certificate, routing, forwarding policy, firewall | Supported with explicit immediate-peer trust |
