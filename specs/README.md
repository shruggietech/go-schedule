...
| 041-guided-windows-uninstall | Implemented | maintenance-only Windows application-management registration and canonical eight-gate verification complete; hosted compiled/installed evidence runs in pull-request CI; #98 remains open for #94 attended acceptance |
