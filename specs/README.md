...
| 048-v100-release-cut | Implemented | v1.0.0 preparation boundary, publication-aware badge, release highlights, post-merge qualification contract, first-round review fix, and canonical verification completed on `codex/048-v100-release-cut`; issue [#122](https://github.com/shruggietech/go-schedule/issues/122) |
