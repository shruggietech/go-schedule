...
| 050-v100-release-execution | Implemented | public [v1.0.0](https://github.com/shruggietech/go-schedule/releases/tag/v1.0.0), verified staging run and public checksums, explicit formal-evidence exception on [#122](https://github.com/shruggietech/go-schedule/issues/122#issuecomment-5536182541), and canonical eight-gate verification passed 2026-09-04 |
