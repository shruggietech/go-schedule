...
| 041-guided-windows-uninstall | In Progress | maintenance-only Windows application-management registration implemented; hosted CI correction and review in progress on PR #107; #98 remains open for #94 attended acceptance |
