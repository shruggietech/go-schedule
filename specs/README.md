...
| 047-windows-release-qualification | Implemented | 43-scenario gate, collector templates, local demo, maintainer acceptance, three Post-v1 follow-ups, and canonical verification completed on `codex/047-windows-release-qualification`; push intentionally withheld |
