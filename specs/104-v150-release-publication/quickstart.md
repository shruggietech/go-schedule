...
5. Record the standing native-testing waiver's application on #185. Use the separately documented manual publication path and disclose untested checks. Never invent evidence, dispatch the full-evidence `Promote Release` workflow without genuine evidence, or hide an automated failure.
