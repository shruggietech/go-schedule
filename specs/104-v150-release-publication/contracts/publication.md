...
4. Full qualification requires real passing attended evidence. A waiver path requires explicit maintainer authorization for v1.5.0, disclosure of untested checks, and the same exact-source and artifact-integrity controls; it never feeds synthetic evidence to the full validator.
