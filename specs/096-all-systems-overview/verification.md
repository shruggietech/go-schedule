...
- `npm test` from `desktop/frontend` passed with 25 files and 143 tests.
...
- Review regressions cover progressive target publication, the failed-run summary index, disabled-group exclusion from upcoming work, and supported remote notification triage routing.
