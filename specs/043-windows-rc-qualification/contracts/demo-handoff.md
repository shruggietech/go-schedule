...
- Destructive installed lifecycle: either a result from an approved disposable
  environment or explicit `unavailable on this non-disposable host`
...
5. Windows Settings maintenance entry, cancellation, preserve uninstall, and
   wipe uninstall as distinct journeys.
