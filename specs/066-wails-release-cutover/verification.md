...
17. The authorized second Codex review identified missing font-license attribution in distributable desktop payloads. The canonical Geist and Space Grotesk OFL texts are now embedded with the frontend, staged in every release archive, included inside the macOS application bundle, and installed by the Windows MSI. Brand-consumer, release-workflow, and installer contracts cover the complete inventory.
