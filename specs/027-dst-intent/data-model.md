...
Migration v7 adds the three non-null columns with defaults. All pre-v7 rows therefore read as `wall_clock`, `next_valid`, and `first`. No reverse migration is provided.
