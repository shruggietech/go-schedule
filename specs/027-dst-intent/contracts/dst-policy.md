...
Advanced Settings contains friendly selectors for Time basis, Spring gap, and Fall overlap. Stored wire values remain the enum strings above. Live preview includes the current selections.
