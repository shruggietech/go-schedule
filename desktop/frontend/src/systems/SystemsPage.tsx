...
export interface Drilldown { registrationKey: string; expectedDaemonId?: string; label: string; destination: Extract<Route, 'tasks' | 'schedule' | 'activity' | 'notifications'>; taskId?: string; recordId?: string; recordKind?: string; occurredAt?: string; context: string }
