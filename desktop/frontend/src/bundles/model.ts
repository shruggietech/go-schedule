...
export type BundleBridge = { exportBundle(): Promise<BundleResult>; validate(document: string): Promise<BundleResult>; compare(document: string): Promise<BundleResult>; preview(document: string): Promise<BundleResult>; apply(plan: BundlePlan): Promise<BundleResult> }
