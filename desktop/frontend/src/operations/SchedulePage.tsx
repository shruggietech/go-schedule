...
export function SchedulePage({ bridge, available, refreshToken, targetName = 'This computer', initialRecordId, initialTaskId }: { bridge: OperationsBridge; available: boolean; refreshToken: number; targetName?: string; initialRecordId?: string; initialTaskId?: string }) {
