...
export function App({ bridge = desktopBridge, tasks = nativeTaskBridge, automation = nativeAutomationBridge }: { bridge?: DesktopBridge; tasks?: TaskBridge; automation?: AutomationBridge }) {
