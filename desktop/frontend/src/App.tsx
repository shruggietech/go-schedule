...
export function App({ bridge = desktopBridge, tasks = nativeTaskBridge, automation = nativeAutomationBridge, operations = nativeOperationsBridge, notifications = nativeNotificationBridge, settings = nativeSettingsBridge }: { bridge?: DesktopBridge; tasks?: TaskBridge; automation?: AutomationBridge; operations?: OperationsBridge; notifications?: NotificationBridge; settings?: SettingsBridge }) {
