...
var operations = []Operation{
	...
	{Method: http.MethodGet, RemotePath: "/api/v1/bundles/export", LocalPath: "/v1/bundles/export", ID: "bundles.export", Retry: RetrySafe},
	{Method: http.MethodPost, RemotePath: "/api/v1/bundles/validate", LocalPath: "/v1/bundles/validate", ID: "bundles.validate", Retry: RetrySafe, BodyLimit: 2 << 20},
	{Method: http.MethodPost, RemotePath: "/api/v1/bundles/preview", LocalPath: "/v1/bundles/preview", ID: "bundles.preview", Retry: RetrySafe, BodyLimit: 2 << 20},
	{Method: http.MethodPost, RemotePath: "/api/v1/bundles/compare", LocalPath: "/v1/bundles/compare", ID: "bundles.compare", Retry: RetrySafe, BodyLimit: 2 << 20},
	{Method: http.MethodPost, RemotePath: "/api/v1/bundles/apply", LocalPath: "/v1/bundles/apply", ID: "bundles.apply", Retry: RetryNever, BodyLimit: 64 << 10},
