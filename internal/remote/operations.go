...
var operations = []Operation{
	...
	{Method: http.MethodPost, RemotePath: "/api/v1/tasks", LocalPath: "/v1/tasks", ID: "tasks.create", Retry: RetryNever, BodyLimit: 1 << 20},
	{Method: http.MethodGet, RemotePath: "/api/v1/tasks/{id}", LocalPath: "/v1/tasks/{id}", ID: "tasks.read", Retry: RetrySafe},
	{Method: http.MethodPatch, RemotePath: "/api/v1/tasks/{id}", LocalPath: "/v1/tasks/{id}", ID: "tasks.update", Retry: RetryNever, BodyLimit: 1 << 20},
