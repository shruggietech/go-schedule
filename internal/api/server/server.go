...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /v1/filesystem-watchers", s.handleListFilesystemWatchers)
	s.mux.HandleFunc("POST /v1/filesystem-watchers", s.handleCreateFilesystemWatcher)
	s.mux.HandleFunc("GET /v1/filesystem-watchers/{id}", s.handleGetFilesystemWatcher)
	s.mux.HandleFunc("PATCH /v1/filesystem-watchers/{id}", s.handleUpdateFilesystemWatcher)
	s.mux.HandleFunc("DELETE /v1/filesystem-watchers/{id}", s.handleDeleteFilesystemWatcher)
	s.mux.HandleFunc("POST /v1/filesystem-watchers/{id}/enable", s.handleEnableFilesystemWatcher)
	s.mux.HandleFunc("POST /v1/filesystem-watchers/{id}/disable", s.handleDisableFilesystemWatcher)
	s.mux.HandleFunc("GET /v1/trigger-sets", s.handleListTriggerSets)
	s.mux.HandleFunc("POST /v1/trigger-sets", s.handleCreateTriggerSet)
	s.mux.HandleFunc("GET /v1/trigger-sets/{id}", s.handleGetTriggerSet)
	s.mux.HandleFunc("PATCH /v1/trigger-sets/{id}", s.handleRetargetTriggerSet)
	s.mux.HandleFunc("DELETE /v1/trigger-sets/{id}", s.handleDeleteTriggerSet)
	s.mux.HandleFunc("POST /v1/trigger-sets/{id}/enable", s.handleEnableTriggerSet)
	s.mux.HandleFunc("POST /v1/trigger-sets/{id}/disable", s.handleDisableTriggerSet)
	s.mux.HandleFunc("POST /v1/trigger-sets/{id}/rotate", s.handleRotateTriggerSet)
	s.mux.HandleFunc("POST /v1/trigger-sets/{id}/reveal", s.handleRevealTriggerSet)
