...
func TestExport_OrdinalWeekdaySelectorBoundary(t *testing.T) {
	...
	for _, rule := range []string{
		...
		"FREQ=MONTHLY;COUNT=3;BYDAY=+3WE;BYHOUR=9;BYMINUTE=0;BYSECOND=0",
		"FREQ=MONTHLY;UNTIL=20261231T000000Z;BYDAY=+3WE;BYHOUR=9;BYMINUTE=0;BYSECOND=0",
		"FREQ=MONTHLY;BYDAY=+3WE;BYHOUR=9,10;BYMINUTE=0;BYSECOND=0",
		"FREQ=MONTHLY;BYDAY=+3WE;BYHOUR=9;BYMINUTE=0,30;BYSECOND=0",
		"FREQ=MONTHLY;BYDAY=+3WE;BYHOUR=9;BYMINUTE=0;BYSECOND=30",
