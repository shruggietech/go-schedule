...
var catalog = []Operation{
	...
	op("GET", "/v1/search", "search.read", domain.CapabilityObserve, "daemon", AuditNone),
	op("GET", "/v1/bundles/export", "bundles.export", domain.CapabilityObserve, "bundle", AuditNone),
	op("POST", "/v1/bundles/validate", "bundles.validate", domain.CapabilityObserve, "bundle", AuditNone),
	op("POST", "/v1/bundles/preview", "bundles.preview", domain.CapabilityObserve, "bundle", AuditNone),
	op("POST", "/v1/bundles/compare", "bundles.compare", domain.CapabilityObserve, "bundle", AuditNone),
	op("POST", "/v1/bundles/apply", "bundles.apply", domain.CapabilityManage, "bundle", AuditMutation),
	...
	op("POST", "/v1/tasks/{id}/enable", "tasks.enable", domain.CapabilityOperate, "task", AuditMutation),
	op("POST", "/v1/tasks/{id}/disable", "tasks.disable", domain.CapabilityOperate, "task", AuditMutation),
